...
//        TODO ALWAYS - set these to false before release
    ...
    struct SpecificSkillIds {
        ...
        static let regularArmorSkills: [Int] = [toughSkin, painTolerance, naturalArmor]
        static let bulletProofArmorSkills: [Int] = [scaledSkin]
        static let plotArmorSkills: [Int] = [plotArmor]
